...
@IBDesignable
open class CustomSegments: UIView {
    ...
    @IBInspectable open var containerBackgroundColor: UIColor = CustomSegments.UIColorFromRGB(0xF4F4F4)
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColors: [UIColor]? = [CustomSegments.UIColorFromRGB(0xFFE900),CustomSegments.UIColorFromRGB(0xFFB400)]
    @IBInspectable open var thumbShadowColor: UIColor = CustomSegments.UIColorFromRGB(0x9B9B9B)
    ...
    open var itemTitles: [String] = ["Expense", "Income", "Transfer"]
...
extension CustomSegments {
    ...
    fileprivate func configureContainerView() {
        ...
        containerView.layer.borderColor = Utils.hexStringToUIColor(hex: AppColors.PRIMARY_COLOR).cgColor
...
extension CustomSegments {
    ...
    fileprivate func changeThumbFrameForPoint(_ point: CGPoint, animated: Bool) {
        ...
        let width = selectedViewWidthForPoint(CGPoint(x: selectedLabelsView.frame.width, y: selectedLabelsView.frame.height))
