...
final public class AESEncrypt {
    ...
    public class func encryptString(_ str: String, password: String, iv: String) -> String? {
...
private func arrayOfBytes<T>(value: T, length: Int? = nil) -> Array<UInt8> {
    ...
    //above is replace by below after swift version 5
